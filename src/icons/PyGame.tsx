export default function SvgPyGame() {
    return (
        <svg viewBox="0 0 200 200">
            ...
            <path fill="#ab9404" stroke="#000" strokeWidth="2" d="M36.9 83.2S51.9 157 50 200c-2 43 75.7 29.9 75.7 29.9s10.2-21 12.8-30c2.6-8.8 35.2-90.4 39.8-96 4.6-5.6-141.4-20.7-141.4-20.7z" />
            <path
                fill="#dbbc06"
                d="M108.5 91.4l-18.7 139C108.1 232 125 229 125 229s9.9-20.4 12.5-29.3c2.7-8.8 36.6-93.4 41.2-99 2.3-2.8-34-4.8-70.2-9.3z"
                color="#000"
            ...
            />
            <path fill="#c7ceca" stroke="#000" strokeWidth="2.2" d="M56.4 106.5a32.8 32.8 0 1021.8 57.4 13 13 0 007.5 5.2 68.2 68.2 0 0024.7 2c3.7-.4 6.1 1.5 8.4-.2 1.8 4.2 17 13.3 28.5 13.3a32.8 32.8 0 10-24.6-54.6c-5-6-14.1-8.7-22.1-9.6a26 26 0 00-16 2.5c-6-10-16.7-16-28.2-16h0z" />
            ...
            <path fill="#fde32c" stroke="#000" strokeWidth="2" d="M50.2 102.4s-21-13-22-21.7c-.8-8.6 2.5-15.8 9.5-30s16.8-43 39.8-44c23-.9 21.5 13.8 37.8 15.7 16.2 1.8 14-9 39.4-5.4 21.2 3 18.5 27.9 22.4 38.7 5 13.7 14.8 44.3 2.7 50.6-12.1 6.3-27.7 16.8-46 25.1-15 6.7-60 8.3-83.6-29z" />
            <path fill="#fff" stroke="#000" strokeWidth="2" d="M66.1 74.8S49.5 58.4 58.6 34c6.7-18 25.6-20.2 33.9-10.7C109.7 43 93 69 93 69M122.8 73.8s-10-20.3 6-40.9c11.6-15.2 27.4-7.2 32.5 4.4C174.6 66.9 146.1 86 146.1 86" />
            <ellipse cx="85.5" cy="60.4" rx="6.2" ry="6.4" />
            <ellipse cx="130.6" cy="65.9" rx="6.2" ry="6.4" />
            <path fill="#2c312f" stroke="#000" strokeWidth="2" d="M57.2 127l-1.2 8.6-8.6-1.2-1.2 8.7 8.7 1.1-1.2 8.7 8.7 1.1 1.1-8.7 8.7 1.2 1.1-8.7-8.6-1.1 1.1-8.6z" filter="url(#a)" />
            <path fillOpacity=".6" d="M64 119l-1 35.7 11.7-33.3z" />
            <path fill="#e9ebeb" stroke="#000" strokeWidth="1.5" d="M66.2 115.4l-1 35.6 11.7-33.2z" />
            <circle cx="134.2" cy="148" r="5.8" fill="#b90e0c" />
            <path fillOpacity=".6" d="M131.7 129.8l3.8 35.5 7.1-34.6z" />
            <path fill="#e9ebeb" stroke="#000" strokeWidth="1.5" d="M133.9 126.2l3.9 35.4 7-34.5z" />
            <circle cx="150.4" cy="139.1" r="5.8" fill="#b90e0c" />
            <ellipse cx="116.4" cy="91.1" fillOpacity=".3" rx="54.3" ry="32.7" transform="rotate(7.9)" />
            <ellipse cx="116.5" cy="86.8" fill="#fde32c" stroke="#000" strokeWidth="2" rx="54.3" ry="32.7" transform="rotate(7.9)" />
            ...
            <path fill="#fde32c" stroke="#000" strokeWidth="2" d="M75 163c-2.4.1-4.9 1.3-6.9 3.8s-3.4 6.3-3.8 9.7c-.5 3.4.2 6.5 2.1 9.3a34.5 34.5 0 0018.4 11.7 62.7 62.7 0 0024 .7c3.9-.7 7.1-1.9 9.6-3.4 2.5-1.6 4.3-3.5 5.4-5.8a20 20 0 001.6-7.6c0-2.4-.2-4.3-.7-6a8.7 8.7 0 00-2.4-4.5c-1.2-1-3-1.2-4.8-1.2l-6.8.3a73.6 73.6 0 01-18.3-2c-3.3-.8-6.8-2-9.7-3-2.9-1-5.2-2-7.6-2z" />
            ...
            <rect width="13" height="4.6" x="-4.6" y="174.8" fill="#2c312f" stroke="#000" strokeWidth="2" ry="1.8" transform="rotate(-30)" />
            <rect width="13" height="4.6" x="9.6" y="185.5" fill="#2c312f" stroke="#000" strokeWidth="2" ry="1.8" transform="rotate(-30)" />
